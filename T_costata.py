...
for percorso in args.spectra:
    ...
    try:
        ...
        T_lista.append((r_reale_calcolata/12.8 - 1.0)/0.0045 + 300.0) # Formula empirica per stimare T da R
...
#T_lista = (r_lista*(1.0 / 12.8) - np.ones(num_file))/0.0045 + np.ones(num_file) * 300.0

# =============================================================================
# 3. COSTRUZIONE VETTORE DI STIMA INIZIALE E OTTIMIZZAZIONE
# =============================================================================
p0_T = T_lista
p0_A = [4.76e-7]       # Guess ampiezza comune
p0_sigmoide = (
#[0.2]+[630.0]+[5.0]+
#[0.2]+[635.0]+[5.0]+
#[0.2]+[645.0]+[5.0]+
